...
<head>
    ...
    <title>DATA ANGSURAN mitra</title>
</head>
<body>
<a href="index.php"><button>HALAMAN UTAMA</button></a>
    <center>
        <h1>
            UPLOADER DATA ANGSURAN MITRA
        </h1>
    <form method="post" enctype="multipart/form-data"
    action="mitraup.php">

    <b>Import Data Pinjaman :</b>
    <input type="file" name="data_mitra" required="required">
...
$no = 1;
$data_mitra = mysqli_query($koneksi, "SELECT * FROM mtr");
while ($data = mysqli_fetch_assoc($data_mitra)) {
    ?>       
<tr>
    <td><?= $no++; ?></td>
